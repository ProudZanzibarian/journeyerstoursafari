                          ...
                          <li>
                            <div className="timeline-content">
                              ...
                              <p>
                                ...
                                qui aliquip ipsa! Dictum natus potenti pretium.
                              </p>
                            </div>
                          </li>
                          <li>
                            <div className="timeline-content">
                              ...
                              <h4>classNameic Rome Sightseeing</h4>
                              <p>
                                Nostra semper ultricies eu leo eros orci porta
                                provident, fugit? Pariatur interdum assumenda,
                                qui aliquip ipsa! Dictum natus potenti pretium.
                      ...
                      <div className="summary-review">
                        ...
                        <div className="review-score-content">
                          ...
                          <p>
                            ...
                            doloremque laboris euismod deserunt non, cupiditate,
                            vestibulum.
                          </p>
                        </div>
                      </div>
            ...
            <div className="col-lg-4">
              <div className="sidebar">
                ...
                <div
                  ...
                  style={{
                    backgroundImage: "url(assets/images/img11.jpg)",
                  }}                >
                  <h5>MORE PACKAGES</h5>
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="#">
                        <i className="far fa-arrow-alt-circle-right"></i>New
                        year packages
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <i className="far fa-arrow-alt-circle-right"></i>Weekend
                        packages
                      </a>
                    </li>
                  </ul>
